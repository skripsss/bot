...
let user = new VK();
user.setOptions({
	token: '32a6282014be04fecc0dbccb002b17417a19601d1f012f548911d7164a905cd903da7031760cdf3fb5d35' // token ot страницы ( не обязательно )
});
let giving = false;
const cars = [
	{
...
vk.setOptions({ token: '32a6282014be04fecc0dbccb002b17417a19601d1f012f548911d7164a905cd903da7031760cdf3fb5d35', pollingGroupId:206717008 });
...
updates.on('message', async (message) => {
	...
	{
		message.send (`[👋🏻]Привет,я игровой бот "ALPHA|Bot".
...
${utils.gi(find() + 1)} ${message.user.tag}, у вас — 🎬 ${utils.sp(message.user.podpis)} сабов`);
	...
	let user = message.user
	 ...
	 if(message.args[1].length > 40) return message.send(`Слишком много символов в названии видео!`);	 
		...
		if(message.user.kanal == true){
		if(message.user.orcase == true) return message.send(`${message.user.tag},Снимать можно раз в 10 минут`);
...
return bot(`вы выиграли 100.000₽ и 1 Карту Героя`); 
} 
...
return bot(`вы выиграли 1.000.000₽ на свой баланс счёт и 1 Карту Героя!`); 
} 
...
return bot(`вы выиграли 5.000.000₽ на свой баланс счёт и 3 Карты Героя!`); 
} 
});
...
cmd.on(/^(?:Статистика)$/i, async (message, bot) =>{
	message.user.foolder += 1;
    return bot(`
	 🔧 Техническая информация бота https://vk.com/alpha0bot (ALPHA|Bot) 🔧
⚙ » OC: Windows 10
🔐 » Версия бота: 2.5
...
${message.user.transport.car === 1 ? '🔹' : '🔸'} 1. Ferrari Enzo V5 (300.000.000.000₽)
${message.user.transport.car === 2 ? '🔹' : '🔸'} 2. Bugatti Chiron (150.200.000.000₽)
${message.user.transport.car === 3 ? '🔹' : '🔸'} 3. McLaren F1 (100.300.000.000₽)
${message.user.transport.car === 4 ? '🔹' : '🔸'} 4. Lamborghini Aventador (74.400.000.000₽)
${message.user.transport.car === 5 ? '🔹' : '🔸'} 5. SSC Tuatara (60.100.000.000₽)
${message.user.transport.car === 6 ? '🔹' : '🔸'} 6. Bugatti Veryon Super (80.000.000.000₽)
${message.user.transport.car === 7 ? '🔹' : '🔸'} 7. Lada Нива (10.000.000₽)
${message.user.transport.car === 8 ? '🔹' : '🔸'} 8. Lada Калина (30.000.000₽)
...
${message.user.realty.home === 1 ? '🔹' : '🔸'} 1. Коттедж Медведева (50.200.000.000₽)
${message.user.realty.home === 2 ? '🔹' : '🔸'} 2. Особняк Порошенко (100.200.000.000₽)
${message.user.realty.home === 3 ? '🔹' : '🔸'} 3. Дом на Рублёвке (200.200.000.000₽)
${message.user.realty.home === 4 ? '🔹' : '🔸'} 4. Личный небоскрёб Tramp'a(250.100.000.000₽)
${message.user.realty.home === 5 ? '🔹' : '🔸'} 5. Остров с особняком (300.600.000.000₽)
${message.user.realty.home === 6 ? '🔹' : '🔸'} 6. Белый дом Путина (500.200.000.000₽)
...
${message.user.realty.apartment === 1 ? '🔹' : '🔸'} 1. Чердак (20.000.000₽)
${message.user.realty.apartment === 2 ? '🔹' : '🔸'} 2. Квартира в общежитии (500.000.000₽)
${message.user.realty.apartment === 3 ? '🔹' : '🔸'} 3. Однокомнатная квартира (1.500.000.000₽)
${message.user.realty.apartment === 4 ? '🔹' : '🔸'} 4. Двухкомнатная квартира (6.100.000.000₽)
${message.user.realty.apartment === 5 ? '🔹' : '🔸'} 5. Четырехкомнатная квартира (15.550.000.000₽)
${message.user.realty.apartment === 6 ? '🔹' : '🔸'} 6. Квартира в центре Москвы (25.500.000.000₽)
${message.user.realty.apartment === 7 ? '🔹' : '🔸'} 7. Двухуровневая квартира (30.500.000.000₽)
${message.user.realty.apartment === 8 ? '🔹' : '🔸'} 8. Квартира с Евроремонтом (50.200.000.000₽)
...
🔹 1. Шаурмичная - 500.000₽
⠀ 💰 Прибыль: 200₽/час
🔹 2. Ларёк - 800.100.000₽
⠀ 💰 Прибыль: 700₽/час
🔹 3. Забегаловка - 1.000.000.000₽
⠀ 💰 Прибыль: 2.700₽/час
🔹 4. Мини-Магазин - 2.000.300.000₽
⠀ 💰 Прибыль: 4.100₽/час
🔹 5. Завод в гараже - 2.000.500.000₽
⠀ 💰 Прибыль: 8.800₽/час
🔹 6.Угольная Шахта - 25.000.000.000₽
⠀ 💰 Прибыль: 84.700₽/час
🔹 7. Маленький Офис - 80.000.000.000₽
⠀ 💰 Прибыль: 229.625₽/час
🔹 8. Любительский GameDev - 150.000.000.000₽
⠀ 💰 Прибыль: 302.000₽/час
🔹 9. Нефтевышка - 500.000.000.000₽
⠀ 💰 Прибыль: 707.000₽/час
🔹 10. Мини АЭС - 800.000.000.000₽
⠀ 💰 Прибыль: 1.000.050.700₽/час
🔸 11. Apple Store - 250.000.000.000.00₽
⠀ 💰 Прибыль: 250.000.000.000₽/час
...
let prize = utils.pick([1]);
	...
	{
		message.user.pass = 1;
		return bot(`🧔 Здравствуйте , я Алексеев Владислав Андреевич !
